...
header <- dashboardHeader(
            title = "Synthetic Control Method simulation for comparable case study --kca&yli",
            titleWidth = 850,
            dropdownMenu(
                        type = "messages",
                        messageItem(from = "kca & yli",
                                    message = "microdata analysis"),
                        messageItem(
                                    from = "Do you like medcine ball?",
                                    message = "Join in us!",
                                    icon = icon("question"),
                                    time = "24:01"
                        ),
...
sidebar <- dashboardSidebar(
            ...
            sliderInput(
                        inputId = "seed.obs.random",
                        label = "seed.obs.random",
                        value = 2, min = 1, max = 10000, step = 1)
                        ...
                        tabItem(
                                              ...
                                              column(width = 4,
                                                     ...
                                                     box(width = NULL,
                                                         ...
                                                         sliderInput(
                                                                     inputId = "rou",
                                                                     label = "rou",
                                                                     value = 0.2 , min = 0, max = 10 , step = 0.05),
                                    ...
                                    fluidRow(  
                                                ...
                                                column(width = 4,       
                                                       ...
                                                       box(width = NULL,
                                                           title = "alpha_value_random", 
                                                           status = "warning", 
                                                           solidHeader = TRUE,
                                                           background = "red",
                                                           verbatimTextOutput(c("alpha_value_random"))),
